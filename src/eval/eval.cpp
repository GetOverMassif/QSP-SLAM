...
int main(int argc, char **argv) {
    ...
    std::cout << "current_folder_path = " << current_folder_path << std::endl;
    WORK_SPACE_PATH = current_folder_path + "/" + "/../../";
    yamlfile_object = "/home/lj/Documents/codes/QSP-SLAM/configs/self_allobject_circle.yaml";

    // cv::FileStorage fSettings(WORK_SPACE_PATH + "/config/"+ yamlfile_object,  cv::FileStorage::READ );
    cv::FileStorage fSettings(yamlfile_object,  cv::FileStorage::READ );
    ...
    // 1    6       39 1 0     -2.490566 0.549101 0.760439     0.000000 0.000000 0.000000 1.000000     0.072986 0.072986 0.289319   # bottle1
    // obj | obj_id | class | | | x | y | z | qx | qy | qz | qw | w | h | l |
