...
bool LocalMapping::RunWhileNewKeyFrame()
{
    bool result = true;
    while (CheckNewKeyFrames() && result) {
        result = RunOneTime();
    }
    return result;
}
...
void LocalMapping::InsertKeyFrame(KeyFrame *pKF)
{
    ...
    std::cout << " mpLocalMapper->InsertKeyFrame: " << pKF->mnId << std::endl;
